...
import data from "../../../public/examples/dsb_dk";
...
function impactWeight(violations, impact) {
  return violations.filter((el) => el.includes(impact));
}

const moderateImpact = impactWeight(data.violations, "moderate");

//const minorImpact = data.violations.filter((minor));
//const moderateImpact = data.violations.filter("moderate");

// "minor", "moderate", "serious", or "critical"

export default function Page() {
  console.log(minorImpact);
  console.log(moderateImpact);
